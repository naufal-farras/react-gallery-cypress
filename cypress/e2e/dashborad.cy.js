describe("Dashboard Page Test Cases", () =>{
    ...
    it('Upload some photos', () => {
        const photos = [
            {
                imageValue : "https://pentasada.co.id/wp-content/uploads/2018/10/Logo-Bank-BNI-dark_BG.png",
                descriptionValue : "Image 1 : Lorem Ipsum",
            },
            {
                imageValue : "https://images.unsplash.com/photo-1658595638853-fbe4a8e80821?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw0fHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60",
